...
public class Aplication {
	...
	public static void main(String[] args) {
		...
		Operacao op01;
		try {
			op01 = new Operacao('s',120.50f);
			Operacao op02 = new Operacao('s',22);
		...
		*/
		...
		Operacao saq02 = new Operacao('s',1f);
		...
		} catch (OperacaoDesconhecidaException e) {
			e.printStackTrace();
		} catch (ValorNegativoZeroException e) {
			e.printStackTrace();
		}
